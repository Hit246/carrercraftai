...
export const ResumeBuilder = () => {
    ...
    const handleExportPdf = async () => {
        ...
        if (pdf) {
            ...
            if (plan !== 'pro' && plan !== 'recruiter') await useCredit();
    ...
    const handleTogglePublic = async (isPublic: boolean) => {
        ...
        try {
            ...
            toast({ 
                title: isPublic ? "Resume is now Public" : "Resume is now Private",
                description: isPublic ? "Anyone with the link can view it." : "Sharing link is disabled."
            });
        } catch (e) {
                ...
                onApplyChanges={(newData) => {
                    ...
                    setResumeData(prev => {
                        ...
                        return {
                            ...
                            ...newData, // Apply AI suggested partial or full changes
                            // If AI provided new list data, map it with stable IDs, otherwise keep existing lists
                            experience: newData.experience ? safeMap(newData.experience) : prev.experience,
                            education: newData.education ? safeMap(newData.education) : prev.education,
                            projects: newData.projects ? safeMap(newData.projects) : prev.projects,
                        };
                    });
