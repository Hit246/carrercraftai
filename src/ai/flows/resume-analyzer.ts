...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a world-class career coach and expert resume critic. Your task is to provide a detailed, constructive, and highly specific analysis of the provided resume PDF.
